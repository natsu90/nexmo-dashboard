	...
	*/
	...
	public function postSetupNexmo()
	{
		...
		try {
			...
			// set dn callback url
			Queue::getIron()->addSubscriber('setDnCallbackUrl', array('url' => url('queue/receive')));
        	Queue::push('setDnCallbackUrl', array('nexmo_key' => $nexmo_key, 'nexmo_secret' => $nexmo_secret));
